...
C     
C     Process: s s~ > z > mu+ mu- mu+ mu- WEIGHTED<=8 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS5_2(W(1,5),W(1,7),GC_115,MDL_MMU,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_3_0(W(1,9),W(1,6),W(1,8),GC_81,GC_77,AMP(1))
      CALL FFS5_1(W(1,6),W(1,7),GC_115,MDL_MMU,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFS5_3(W(1,3),W(1,4),GC_115,MDL_MH,MDL_WH,W(1,15))
      CALL FFV2_3_2(W(1,5),W(1,14),GC_81,GC_77,MDL_MMU,ZERO,W(1,16))
C     Amplitude(s) for diagram number 5
      CALL FFS5_0(W(1,16),W(1,6),W(1,15),GC_115,AMP(5))
      CALL FFV2_3_1(W(1,6),W(1,14),GC_81,GC_77,MDL_MMU,ZERO,W(1,17))
C     Amplitude(s) for diagram number 6
      CALL FFS5_0(W(1,5),W(1,17),W(1,15),GC_115,AMP(6))
...
C     Amplitude(s) for diagram number 19
      ...
      CALL FFS5_3(W(1,3),W(1,6),GC_115,MDL_MH,MDL_WH,W(1,12))
      CALL FFV2_3_1(W(1,4),W(1,14),GC_81,GC_77,MDL_MMU,ZERO,W(1,23))
C     Amplitude(s) for diagram number 20
      CALL FFS5_0(W(1,5),W(1,23),W(1,12),GC_115,AMP(20))
C     Amplitude(s) for diagram number 21
      CALL FFS5_0(W(1,16),W(1,4),W(1,12),GC_115,AMP(21))
...
C     Amplitude(s) for diagram number 29
      ...
      CALL FFS5_3(W(1,5),W(1,4),GC_115,MDL_MH,MDL_WH,W(1,16))
C     Amplitude(s) for diagram number 30
      CALL VVS1_0(W(1,14),W(1,21),W(1,16),GC_101,AMP(30))
      CALL FFS5_2(W(1,3),W(1,7),GC_115,MDL_MMU,ZERO,W(1,26))
...
C     Amplitude(s) for diagram number 34
      ...
      CALL FFV2_3_2(W(1,3),W(1,14),GC_81,GC_77,MDL_MMU,ZERO,W(1,13))
C     Amplitude(s) for diagram number 35
      CALL FFS5_0(W(1,13),W(1,6),W(1,16),GC_115,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFS5_0(W(1,3),W(1,17),W(1,16),GC_115,AMP(36))
...
C     Amplitude(s) for diagram number 47
      CALL FFS5_0(W(1,13),W(1,4),W(1,20),GC_115,AMP(47))
C     Amplitude(s) for diagram number 48
      CALL FFS5_0(W(1,3),W(1,23),W(1,20),GC_115,AMP(48))
