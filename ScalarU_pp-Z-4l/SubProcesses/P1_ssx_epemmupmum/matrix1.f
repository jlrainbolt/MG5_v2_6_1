...
C     
C     Process: s s~ > z > e+ e- mu+ mu- WEIGHTED<=8 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFS5_2(W(1,1),W(1,11),GC_117,MDL_MS,ZERO,W(1,7))
C     Amplitude(s) for diagram number 28
      CALL FFV2_3_0(W(1,7),W(1,2),W(1,15),GC_79,GC_75,AMP(28))
      CALL FFV2_3_2(W(1,1),W(1,15),GC_79,GC_75,MDL_MS,ZERO,W(1,7))
C     Amplitude(s) for diagram number 29
      CALL FFS5_0(W(1,7),W(1,2),W(1,11),GC_117,AMP(29))
      CALL FFV1_2(W(1,1),W(1,14),GC_1,MDL_MS,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 31
      ...
      CALL FFV2_3_2(W(1,1),W(1,8),GC_79,GC_75,MDL_MS,ZERO,W(1,14))
C     Amplitude(s) for diagram number 32
      CALL FFS5_0(W(1,14),W(1,2),W(1,13),GC_117,AMP(32))
      CALL FFS5_2(W(1,1),W(1,13),GC_117,MDL_MS,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 34
      ...
      CALL FFV1_2(W(1,1),W(1,10),GC_1,MDL_MS,ZERO,W(1,11))
