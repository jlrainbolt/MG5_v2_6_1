...
C     
C     Process: c c~ > z > e+ e- e+ e- WEIGHTED<=8 @1
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFS5_3(W(1,1),W(1,2),GC_104,MDL_MH,MDL_WH,W(1,7))
...
C     Amplitude(s) for diagram number 54
      ...
      CALL FFS5_2(W(1,1),W(1,15),GC_104,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 55
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,19),GC_80,GC_76,AMP(55))
      CALL FFV2_3_2(W(1,1),W(1,19),GC_80,GC_76,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 56
      CALL FFS5_0(W(1,10),W(1,2),W(1,15),GC_104,AMP(56))
...
C     Amplitude(s) for diagram number 58
      ...
      CALL FFV2_3_2(W(1,1),W(1,8),GC_80,GC_76,MDL_MC,ZERO,W(1,18))
C     Amplitude(s) for diagram number 59
      CALL FFS5_0(W(1,18),W(1,2),W(1,20),GC_104,AMP(59))
      CALL FFS5_2(W(1,1),W(1,20),GC_104,MDL_MC,ZERO,W(1,15))
...
C     Amplitude(s) for diagram number 64
      ...
      CALL FFS5_2(W(1,1),W(1,12),GC_104,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 65
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,25),GC_80,GC_76,AMP(65))
      CALL FFV2_3_2(W(1,1),W(1,25),GC_80,GC_76,MDL_MC,ZERO,W(1,10))
C     Amplitude(s) for diagram number 66
      CALL FFS5_0(W(1,10),W(1,2),W(1,12),GC_104,AMP(66))
...
C     Amplitude(s) for diagram number 68
      ...
      CALL FFV2_3_2(W(1,1),W(1,21),GC_80,GC_76,MDL_MC,ZERO,W(1,24))
C     Amplitude(s) for diagram number 69
      CALL FFS5_0(W(1,24),W(1,2),W(1,16),GC_104,AMP(69))
      CALL FFS5_2(W(1,1),W(1,16),GC_104,MDL_MC,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 71
      ...
      CALL FFV1_2(W(1,1),W(1,14),GC_2,MDL_MC,ZERO,W(1,12))
