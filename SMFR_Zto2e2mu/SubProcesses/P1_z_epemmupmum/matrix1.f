...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV1_2(W(1,2),W(1,6),GC_3,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,1),GC_80,GC_76,AMP(9))
      CALL FFV1_1(W(1,3),W(1,6),GC_3,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 10
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,1),GC_80,GC_76,AMP(10))
      CALL FFV2_3_2(W(1,2),W(1,7),GC_80,GC_76,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,1),GC_80,GC_76,AMP(11))
      CALL FFV2_3_1(W(1,3),W(1,7),GC_80,GC_76,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,1),GC_80,GC_76,AMP(12))
      CALL FFS1_2_2(W(1,2),W(1,8),GC_113,GC_113,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,1),GC_80,GC_76,AMP(13))
      CALL FFS1_2_1(W(1,3),W(1,8),GC_113,GC_113,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,1),GC_80,GC_76,AMP(14))
