...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_3_3(W(1,1),W(1,2),GC_50,GC_58,MDL_MZ,MDL_WZ,W(1,9))
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,1),W(1,10),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,12),GC_50,GC_58,AMP(13))
      CALL FFV2_3_2(W(1,1),W(1,12),GC_50,GC_58,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,5),W(1,2),W(1,10),GC_1,AMP(14))
      CALL FFV2_3_2(W(1,1),W(1,8),GC_50,GC_58,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,10),W(1,2),W(1,11),GC_1,AMP(15))
      CALL FFV1_2(W(1,1),W(1,11),GC_1,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,3),W(1,2),W(1,8),GC_50,GC_58,AMP(16))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,10),W(1,2),W(1,12),GC_50,GC_58,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,8),GC_50,GC_58,AMP(18))
