...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV1_2(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 25
      CALL FFV2_5_0(W(1,17),W(1,2),W(1,14),GC_51,GC_58,AMP(25))
      CALL FFV2_5_2(W(1,1),W(1,14),GC_51,GC_58,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,17),W(1,2),W(1,12),GC_2,AMP(26))
      CALL FFV2_5_2(W(1,1),W(1,8),GC_51,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 27
      CALL FFV1_0(W(1,12),W(1,2),W(1,16),GC_2,AMP(27))
      CALL FFV1_2(W(1,1),W(1,16),GC_2,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 28
      CALL FFV2_5_0(W(1,3),W(1,2),W(1,8),GC_51,GC_58,AMP(28))
C     Amplitude(s) for diagram number 29
      CALL FFV2_5_0(W(1,12),W(1,2),W(1,14),GC_51,GC_58,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_5_0(W(1,17),W(1,2),W(1,8),GC_51,GC_58,AMP(30))
      CALL FFV1_2(W(1,1),W(1,9),GC_2,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,17),W(1,2),W(1,13),GC_51,GC_58,AMP(31))
      CALL FFV2_5_2(W(1,1),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,17))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,17),W(1,2),W(1,9),GC_2,AMP(32))
      CALL FFV2_5_2(W(1,1),W(1,15),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,9),W(1,2),W(1,10),GC_2,AMP(33))
      CALL FFV1_2(W(1,1),W(1,10),GC_2,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 34
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,15),GC_51,GC_58,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,13),GC_51,GC_58,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,17),W(1,2),W(1,15),GC_51,GC_58,AMP(36))
