...
C     Amplitude(s) for diagram number 34
      ...
      CALL FFS1_2(W(1,2),W(1,6),GC_13,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 35
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,1),GC_81,GC_77,AMP(35))
      CALL FFS1_1(W(1,3),W(1,6),GC_13,MDL_ME,ZERO,W(1,5))
