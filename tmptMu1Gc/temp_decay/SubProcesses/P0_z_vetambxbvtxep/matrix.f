...
C     
C     Process: z > ve ta- b~ b vt~ e+
C     Process: z > vm ta- b~ b vt~ mu+
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     ----------
      ...
      CALL FFV2_3(W(1,7),W(1,2),GC_100,MDL_MW,MDL_WW,W(1,8))
      CALL FFV2_3(W(1,6),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_1(W(1,5),W(1,8),GC_100,MDL_MT,MDL_WT,W(1,6))
...
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,7),W(1,8),W(1,1),GC_53,AMP(2))
