...
C     
C     Process: z > ve w- b~ b e+
C     Process: z > vm w- b~ b mu+
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,  57),I=1,6) / 0,-1, 0, 1,-1, 1/
      DATA (NHEL(I,  58),I=1,6) / 0,-1, 0, 1,-1,-1/
      DATA (NHEL(I,  59),I=1,6) / 0,-1, 0, 1, 1, 1/
      DATA (NHEL(I,  60),I=1,6) / 0,-1, 0, 1, 1,-1/
      DATA (NHEL(I,  61),I=1,6) / 0,-1, 0,-1,-1, 1/
      DATA (NHEL(I,  62),I=1,6) / 0,-1, 0,-1,-1,-1/
      DATA (NHEL(I,  63),I=1,6) / 0,-1, 0,-1, 1, 1/
      DATA (NHEL(I,  64),I=1,6) / 0,-1, 0,-1, 1,-1/
      DATA (NHEL(I,  65),I=1,6) / 0,-1,-1, 1,-1, 1/
      DATA (NHEL(I,  66),I=1,6) / 0,-1,-1, 1,-1,-1/
      DATA (NHEL(I,  67),I=1,6) / 0,-1,-1, 1, 1, 1/
      DATA (NHEL(I,  68),I=1,6) / 0,-1,-1, 1, 1,-1/
      DATA (NHEL(I,  69),I=1,6) / 0,-1,-1,-1,-1, 1/
      DATA (NHEL(I,  70),I=1,6) / 0,-1,-1,-1,-1,-1/
      DATA (NHEL(I,  71),I=1,6) / 0,-1,-1,-1, 1, 1/
      DATA (NHEL(I,  72),I=1,6) / 0,-1,-1,-1, 1,-1/
      DATA (NHEL(I,  73),I=1,6) / 0, 1, 1, 1,-1, 1/
      DATA (NHEL(I,  74),I=1,6) / 0, 1, 1, 1,-1,-1/
      DATA (NHEL(I,  75),I=1,6) / 0, 1, 1, 1, 1, 1/
      DATA (NHEL(I,  76),I=1,6) / 0, 1, 1, 1, 1,-1/
      DATA (NHEL(I,  77),I=1,6) / 0, 1, 1,-1,-1, 1/
      DATA (NHEL(I,  78),I=1,6) / 0, 1, 1,-1,-1,-1/
      DATA (NHEL(I,  79),I=1,6) / 0, 1, 1,-1, 1, 1/
      DATA (NHEL(I,  80),I=1,6) / 0, 1, 1,-1, 1,-1/
      DATA (NHEL(I,  81),I=1,6) / 0, 1, 0, 1,-1, 1/
      DATA (NHEL(I,  82),I=1,6) / 0, 1, 0, 1,-1,-1/
      DATA (NHEL(I,  83),I=1,6) / 0, 1, 0, 1, 1, 1/
      DATA (NHEL(I,  84),I=1,6) / 0, 1, 0, 1, 1,-1/
      DATA (NHEL(I,  85),I=1,6) / 0, 1, 0,-1,-1, 1/
      DATA (NHEL(I,  86),I=1,6) / 0, 1, 0,-1,-1,-1/
      DATA (NHEL(I,  87),I=1,6) / 0, 1, 0,-1, 1, 1/
      DATA (NHEL(I,  88),I=1,6) / 0, 1, 0,-1, 1,-1/
      ...
      DATA (NHEL(I, 105),I=1,6) / 1,-1, 0, 1,-1, 1/
      DATA (NHEL(I, 106),I=1,6) / 1,-1, 0, 1,-1,-1/
      DATA (NHEL(I, 107),I=1,6) / 1,-1, 0, 1, 1, 1/
      DATA (NHEL(I, 108),I=1,6) / 1,-1, 0, 1, 1,-1/
      DATA (NHEL(I, 109),I=1,6) / 1,-1, 0,-1,-1, 1/
      DATA (NHEL(I, 110),I=1,6) / 1,-1, 0,-1,-1,-1/
      DATA (NHEL(I, 111),I=1,6) / 1,-1, 0,-1, 1, 1/
      DATA (NHEL(I, 112),I=1,6) / 1,-1, 0,-1, 1,-1/
      DATA (NHEL(I, 113),I=1,6) / 1,-1,-1, 1,-1, 1/
      DATA (NHEL(I, 114),I=1,6) / 1,-1,-1, 1,-1,-1/
      DATA (NHEL(I, 115),I=1,6) / 1,-1,-1, 1, 1, 1/
      DATA (NHEL(I, 116),I=1,6) / 1,-1,-1, 1, 1,-1/
      ...
      DATA (NHEL(I, 134),I=1,6) / 1, 1, 0,-1,-1,-1/
      DATA (NHEL(I, 135),I=1,6) / 1, 1, 0,-1, 1, 1/
      DATA (NHEL(I, 136),I=1,6) / 1, 1, 0,-1, 1,-1/
