...
C     
C     Process: z > w+ e- b~ b ve~
C     Process: z > w+ mu- b~ b vm~
C     
      USE DISCRETESAMPLER
      IMPLICIT NONE
C     
...
C     
      ...
      DATA (NHEL(I,  17),I=1,6) /-1, 0,-1, 1,-1, 1/
      DATA (NHEL(I,  18),I=1,6) /-1, 0,-1, 1,-1,-1/
      DATA (NHEL(I,  19),I=1,6) /-1, 0,-1, 1, 1, 1/
      DATA (NHEL(I,  20),I=1,6) /-1, 0,-1, 1, 1,-1/
      DATA (NHEL(I,  21),I=1,6) /-1, 0,-1,-1,-1, 1/
      DATA (NHEL(I,  22),I=1,6) /-1, 0,-1,-1,-1,-1/
      DATA (NHEL(I,  23),I=1,6) /-1, 0,-1,-1, 1, 1/
      DATA (NHEL(I,  24),I=1,6) /-1, 0,-1,-1, 1,-1/
      DATA (NHEL(I,  25),I=1,6) /-1, 0, 1, 1,-1, 1/
      DATA (NHEL(I,  26),I=1,6) /-1, 0, 1, 1,-1,-1/
      DATA (NHEL(I,  27),I=1,6) /-1, 0, 1, 1, 1, 1/
      DATA (NHEL(I,  28),I=1,6) /-1, 0, 1, 1, 1,-1/
      DATA (NHEL(I,  29),I=1,6) /-1, 0, 1,-1,-1, 1/
      DATA (NHEL(I,  30),I=1,6) /-1, 0, 1,-1,-1,-1/
      DATA (NHEL(I,  31),I=1,6) /-1, 0, 1,-1, 1, 1/
      DATA (NHEL(I,  32),I=1,6) /-1, 0, 1,-1, 1,-1/
      ...
      DATA (NHEL(I,  49),I=1,6) / 0,-1,-1, 1,-1, 1/
      DATA (NHEL(I,  50),I=1,6) / 0,-1,-1, 1,-1,-1/
      DATA (NHEL(I,  51),I=1,6) / 0,-1,-1, 1, 1, 1/
      DATA (NHEL(I,  52),I=1,6) / 0,-1,-1, 1, 1,-1/
      DATA (NHEL(I,  53),I=1,6) / 0,-1,-1,-1,-1, 1/
      DATA (NHEL(I,  54),I=1,6) / 0,-1,-1,-1,-1,-1/
      DATA (NHEL(I,  55),I=1,6) / 0,-1,-1,-1, 1, 1/
      DATA (NHEL(I,  56),I=1,6) / 0,-1,-1,-1, 1,-1/
      DATA (NHEL(I,  57),I=1,6) / 0,-1, 1, 1,-1, 1/
      DATA (NHEL(I,  58),I=1,6) / 0,-1, 1, 1,-1,-1/
      DATA (NHEL(I,  59),I=1,6) / 0,-1, 1, 1, 1, 1/
      DATA (NHEL(I,  60),I=1,6) / 0,-1, 1, 1, 1,-1/
      DATA (NHEL(I,  61),I=1,6) / 0,-1, 1,-1,-1, 1/
      DATA (NHEL(I,  62),I=1,6) / 0,-1, 1,-1,-1,-1/
      DATA (NHEL(I,  63),I=1,6) / 0,-1, 1,-1, 1, 1/
      DATA (NHEL(I,  64),I=1,6) / 0,-1, 1,-1, 1,-1/
      DATA (NHEL(I,  65),I=1,6) / 0, 0,-1, 1,-1, 1/
      DATA (NHEL(I,  66),I=1,6) / 0, 0,-1, 1,-1,-1/
      DATA (NHEL(I,  67),I=1,6) / 0, 0,-1, 1, 1, 1/
      DATA (NHEL(I,  68),I=1,6) / 0, 0,-1, 1, 1,-1/
      DATA (NHEL(I,  69),I=1,6) / 0, 0,-1,-1,-1, 1/
      DATA (NHEL(I,  70),I=1,6) / 0, 0,-1,-1,-1,-1/
      DATA (NHEL(I,  71),I=1,6) / 0, 0,-1,-1, 1, 1/
      DATA (NHEL(I,  72),I=1,6) / 0, 0,-1,-1, 1,-1/
      DATA (NHEL(I,  73),I=1,6) / 0, 0, 1, 1,-1, 1/
      DATA (NHEL(I,  74),I=1,6) / 0, 0, 1, 1,-1,-1/
      DATA (NHEL(I,  75),I=1,6) / 0, 0, 1, 1, 1, 1/
      DATA (NHEL(I,  76),I=1,6) / 0, 0, 1, 1, 1,-1/
      DATA (NHEL(I,  77),I=1,6) / 0, 0, 1,-1,-1, 1/
      DATA (NHEL(I,  78),I=1,6) / 0, 0, 1,-1,-1,-1/
      DATA (NHEL(I,  79),I=1,6) / 0, 0, 1,-1, 1, 1/
      DATA (NHEL(I,  80),I=1,6) / 0, 0, 1,-1, 1,-1/
      DATA (NHEL(I,  81),I=1,6) / 0, 1,-1, 1,-1, 1/
      DATA (NHEL(I,  82),I=1,6) / 0, 1,-1, 1,-1,-1/
      DATA (NHEL(I,  83),I=1,6) / 0, 1,-1, 1, 1, 1/
      DATA (NHEL(I,  84),I=1,6) / 0, 1,-1, 1, 1,-1/
      DATA (NHEL(I,  85),I=1,6) / 0, 1,-1,-1,-1, 1/
      DATA (NHEL(I,  86),I=1,6) / 0, 1,-1,-1,-1,-1/
      DATA (NHEL(I,  87),I=1,6) / 0, 1,-1,-1, 1, 1/
      DATA (NHEL(I,  88),I=1,6) / 0, 1,-1,-1, 1,-1/
      DATA (NHEL(I,  89),I=1,6) / 0, 1, 1, 1,-1, 1/
      DATA (NHEL(I,  90),I=1,6) / 0, 1, 1, 1,-1,-1/
      DATA (NHEL(I,  91),I=1,6) / 0, 1, 1, 1, 1, 1/
      DATA (NHEL(I,  92),I=1,6) / 0, 1, 1, 1, 1,-1/
      DATA (NHEL(I,  93),I=1,6) / 0, 1, 1,-1,-1, 1/
      DATA (NHEL(I,  94),I=1,6) / 0, 1, 1,-1,-1,-1/
      DATA (NHEL(I,  95),I=1,6) / 0, 1, 1,-1, 1, 1/
      DATA (NHEL(I,  96),I=1,6) / 0, 1, 1,-1, 1,-1/
      ...
      DATA (NHEL(I, 101),I=1,6) / 1,-1,-1,-1,-1, 1/
      DATA (NHEL(I, 102),I=1,6) / 1,-1,-1,-1,-1,-1/
      DATA (NHEL(I, 103),I=1,6) / 1,-1,-1,-1, 1, 1/
      DATA (NHEL(I, 104),I=1,6) / 1,-1,-1,-1, 1,-1/
      ...
      DATA (NHEL(I, 113),I=1,6) / 1, 0,-1, 1,-1, 1/
      DATA (NHEL(I, 114),I=1,6) / 1, 0,-1, 1,-1,-1/
      DATA (NHEL(I, 115),I=1,6) / 1, 0,-1, 1, 1, 1/
      DATA (NHEL(I, 116),I=1,6) / 1, 0,-1, 1, 1,-1/
      DATA (NHEL(I, 117),I=1,6) / 1, 0,-1,-1,-1, 1/
      DATA (NHEL(I, 118),I=1,6) / 1, 0,-1,-1,-1,-1/
      DATA (NHEL(I, 119),I=1,6) / 1, 0,-1,-1, 1, 1/
      DATA (NHEL(I, 120),I=1,6) / 1, 0,-1,-1, 1,-1/
      DATA (NHEL(I, 121),I=1,6) / 1, 0, 1, 1,-1, 1/
      DATA (NHEL(I, 122),I=1,6) / 1, 0, 1, 1,-1,-1/
      DATA (NHEL(I, 123),I=1,6) / 1, 0, 1, 1, 1, 1/
      DATA (NHEL(I, 124),I=1,6) / 1, 0, 1, 1, 1,-1/
      DATA (NHEL(I, 125),I=1,6) / 1, 0, 1,-1,-1, 1/
      DATA (NHEL(I, 126),I=1,6) / 1, 0, 1,-1,-1,-1/
      DATA (NHEL(I, 127),I=1,6) / 1, 0, 1,-1, 1, 1/
      DATA (NHEL(I, 128),I=1,6) / 1, 0, 1,-1, 1,-1/
      DATA (NHEL(I, 129),I=1,6) / 1, 1,-1, 1,-1, 1/
      DATA (NHEL(I, 130),I=1,6) / 1, 1,-1, 1,-1,-1/
      DATA (NHEL(I, 131),I=1,6) / 1, 1,-1, 1, 1, 1/
      ...
      DATA (NHEL(I, 137),I=1,6) / 1, 1, 1, 1,-1, 1/
      DATA (NHEL(I, 138),I=1,6) / 1, 1, 1, 1,-1,-1/
      DATA (NHEL(I, 139),I=1,6) / 1, 1, 1, 1, 1, 1/
      DATA (NHEL(I, 140),I=1,6) / 1, 1, 1, 1, 1,-1/
...
C     ----------
      ...
      CALL FFV2_3(W(1,6),W(1,3),GC_100,MDL_MW,MDL_WW,W(1,7))
      CALL FFV2_1(W(1,5),W(1,2),GC_100,MDL_MT,MDL_WT,W(1,6))
      CALL FFV2_3(W(1,4),W(1,6),GC_100,MDL_MW,MDL_WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVV1_0(W(1,7),W(1,3),W(1,1),GC_53,AMP(1))
      CALL FFV2_2(W(1,4),W(1,7),GC_100,MDL_MT,MDL_WT,W(1,3))
      CALL FFV2_3(W(1,3),W(1,5),GC_100,MDL_MW,MDL_WW,W(1,7))
C     Amplitude(s) for diagram number 2
      CALL VVV1_0(W(1,7),W(1,2),W(1,1),GC_53,AMP(2))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,3),W(1,6),W(1,1),GC_51,GC_58,AMP(3))
