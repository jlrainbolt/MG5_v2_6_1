...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFS5_2(W(1,2),W(1,6),GC_111,MDL_ME,ZERO,W(1,8))
C     Amplitude(s) for diagram number 11
      CALL FFV2_3_0(W(1,8),W(1,3),W(1,1),GC_81,GC_77,AMP(11))
      CALL FFS5_1(W(1,3),W(1,6),GC_111,MDL_ME,ZERO,W(1,8))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,2),W(1,8),W(1,1),GC_81,GC_77,AMP(12))
      CALL FFV1P0_3(W(1,4),W(1,5),GC_3,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,2),W(1,8),GC_3,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 13
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,1),GC_81,GC_77,AMP(13))
      CALL FFV1_1(W(1,3),W(1,8),GC_3,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,2),W(1,6),W(1,1),GC_81,GC_77,AMP(14))
      CALL FFV2_3_2(W(1,2),W(1,9),GC_81,GC_77,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,1),GC_81,GC_77,AMP(15))
      CALL FFV2_3_1(W(1,3),W(1,9),GC_81,GC_77,MDL_ME,ZERO,W(1,6))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,2),W(1,6),W(1,1),GC_81,GC_77,AMP(16))
      CALL FFS1_3(W(1,4),W(1,5),GC_13,MDL_MUB,MDL_WUB,W(1,6))
      CALL FFS1_2(W(1,2),W(1,6),GC_13,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 17
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,1),GC_81,GC_77,AMP(17))
      CALL FFS1_1(W(1,3),W(1,6),GC_13,MDL_ME,ZERO,W(1,5))
C     Amplitude(s) for diagram number 18
      CALL FFV2_3_0(W(1,2),W(1,5),W(1,1),GC_81,GC_77,AMP(18))
