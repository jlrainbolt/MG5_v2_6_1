...
I1ax = Parameter(name = 'I1ax',
                 nature = 'internal',
                 type = 'complex',
                 value = 'gUb1x1 + gUb2x2 + gUb3x3',
                 texname = '\\text{I1ax}')
