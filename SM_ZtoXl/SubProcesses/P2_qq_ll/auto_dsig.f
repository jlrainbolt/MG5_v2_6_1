...
C     
C     Process: u u~ > z > e+ e- WEIGHTED<=4 @2
C     Process: u u~ > z > mu+ mu- WEIGHTED<=4 @2
C     Process: c c~ > z > e+ e- WEIGHTED<=4 @2
C     Process: c c~ > z > mu+ mu- WEIGHTED<=4 @2
C     Process: d d~ > z > e+ e- WEIGHTED<=4 @2
C     Process: d d~ > z > mu+ mu- WEIGHTED<=4 @2
C     Process: s s~ > z > e+ e- WEIGHTED<=4 @2
C     Process: s s~ > z > mu+ mu- WEIGHTED<=4 @2
C     
